# Practical Biometric Authentication
...
* `compose` **module**: Example app using Jetpack Compose.
* `view` **module**: Example app using Views (XML).
* `shared` **module**: Shared logic including Cryptography, ViewModels, and Repositories.
